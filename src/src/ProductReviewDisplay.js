    ...
    reviews: [
      {
        ...
        helpful: 24,
        sellerNote:
          "Customer is satisfied with heat consistency and extraction quality. Consider highlighting these features in marketing.",
      },
      {
        id: 2,
        author: "John Smith",
        ...
        helpful: 18,
        sellerNote:
          "User found learning curve steep. Consider creating a tutorial video or quick-start guide to improve onboarding.",
      },
      {
        id: 3,
        author: "Maria Garcia",
        ...
        helpful: 31,
        sellerNote:
          "Fast heating is a key selling point. Ensure this feature is prominently mentioned in product descriptions.",
      },
    ],
  },
  2: {
    ...
    reviews: [
      {
        ...
        helpful: 12,
        sellerNote:
          "Design and insulation are key strengths. Market as an ideal gift option in seasonal campaigns.",
      },
      {
        id: 5,
        author: "Emma Watson",
        ...
        helpful: 8,
        sellerNote:
          "Weight is unexpected to some customers. Add weight specifications to product listing to manage expectations.",
      },
    ],
  },
  3: {
    ...
    reviews: [
      {
        ...
        helpful: 42,
        sellerNote:
          "Noise level and durability are standout features. Emphasize these benefits to appeal to frequent users.",
      },
    ],
  },
};
    ...
    >
      ...
      {loading && (
        <div style={{ textAlign: "center", padding: "50px" }}>
          <p style={{ fontSize: "1.2rem", color: C.gold }}>
            Loading reviews...
          </p>
        </div>
      )}
              ...
              {product.reviews.map((review) => (
                ...
                >
                  ...
                  <button
                    onClick={() =>
                      setExpandedNoteId(
                        expandedNoteId === review.id ? null : review.id,
                      )
                    }
                    style={{
